    ...
    <>
      <div className="text-center mb-0 border-4 rounded-2xl border-red-900 p-8 "> 
        ...
        <div className="flex justify-center space-x-4 md:space-x-6 mb-12 font-bold text-9xl leading-tight mt-4 sm:mt-10 text-red-900 gap-4 sm:gap-12 md:gap-24 lg:gap-52 ">
          ...
          <a href="#" className="hover:opacity-80 transition-opacity">
            <FaInstagram className="text-6xl sm:text-8xl md:text-9xl" />{" "}
            {/* Increase size to 120px for giant icons */}
          </a>
          <a href="#" className="hover:opacity-80 transition-opacity">
            <FaTwitter className="text-6xl sm:text-8xl md:text-9xl" />{" "}
            {/* Increase size to 120px for giant icons */}
          </a>
        </div>
      </div>
      ...
      <footer className="bg-[#8B2121] text-white font-poppins">
        ...
        <div className="container mx-auto px-4 border-t-2 border-gray-300 py-8">
          ...
          {/* Bottom Bar */}
          <motion.div
            className="border-t border-gray-300 py-8 mt-8 text-center md:flex md:justify-between md:items-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
